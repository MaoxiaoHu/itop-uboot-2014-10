...
#define KEY_PWR_PMIC_NAME		"S5M8767A_PMIC"
#define KEY_PWR_STATUS_REG		S5M8767A_REG_PMIC_STATUS1
#define KEY_PWR_STATUS_MASK		(1 << 0)
#define KEY_PWR_INTERRUPT_REG		S5M8767A_REG_PMIC_ONOFF_INT1
#define KEY_PWR_INTERRUPT_MASK		(1 << 1)

#define KEY_VOL_UP_GPIO			EXYNOS4X12_GPIO_X21
#define KEY_VOL_DOWN_GPIO		EXYNOS4X12_GPIO_X20
#endif /* __ASSEMBLY__ */
/* LCD console */
