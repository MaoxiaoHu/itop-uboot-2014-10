...
static void exynos4x12_i2c_config(int peripheral, int flags)
{
	...
	case PERIPH_ID_I2C0:
		...
		gpio_set_pull(EXYNOS4X12_GPIO_D10,S5P_GPIO_PULL_UP);
		gpio_set_pull(EXYNOS4X12_GPIO_D11,S5P_GPIO_PULL_UP);
		break;
	case PERIPH_ID_I2C1:
		gpio_cfg_pin(EXYNOS4X12_GPIO_D12, S5P_GPIO_FUNC(0x2));
		gpio_cfg_pin(EXYNOS4X12_GPIO_D13, S5P_GPIO_FUNC(0x2));
		gpio_set_pull(EXYNOS4X12_GPIO_D12,S5P_GPIO_PULL_UP);
		gpio_set_pull(EXYNOS4X12_GPIO_D13,S5P_GPIO_PULL_UP);
		break;
	case PERIPH_ID_I2C2:
		gpio_cfg_pin(EXYNOS4X12_GPIO_A06, S5P_GPIO_FUNC(0x3));
		gpio_cfg_pin(EXYNOS4X12_GPIO_A07, S5P_GPIO_FUNC(0x3));
		gpio_set_pull(EXYNOS4X12_GPIO_A06,S5P_GPIO_PULL_UP);
		gpio_set_pull(EXYNOS4X12_GPIO_A07,S5P_GPIO_PULL_UP);
		break;
	case PERIPH_ID_I2C3:
		gpio_cfg_pin(EXYNOS4X12_GPIO_A12, S5P_GPIO_FUNC(0x3));
		gpio_cfg_pin(EXYNOS4X12_GPIO_A13, S5P_GPIO_FUNC(0x3));
		gpio_set_pull(EXYNOS4X12_GPIO_A12,S5P_GPIO_PULL_UP);
		gpio_set_pull(EXYNOS4X12_GPIO_A13,S5P_GPIO_PULL_UP);
		break;
	case PERIPH_ID_I2C4:
		gpio_cfg_pin(EXYNOS4X12_GPIO_B0, S5P_GPIO_FUNC(0x3));
		gpio_cfg_pin(EXYNOS4X12_GPIO_B1, S5P_GPIO_FUNC(0x3));
		gpio_set_pull(EXYNOS4X12_GPIO_B0,S5P_GPIO_PULL_UP);
		gpio_set_pull(EXYNOS4X12_GPIO_B1,S5P_GPIO_PULL_UP);
		break;
	case PERIPH_ID_I2C5:
		gpio_cfg_pin(EXYNOS4X12_GPIO_B2, S5P_GPIO_FUNC(0x3));
		gpio_cfg_pin(EXYNOS4X12_GPIO_B3, S5P_GPIO_FUNC(0x3));
		gpio_set_pull(EXYNOS4X12_GPIO_B2,S5P_GPIO_PULL_UP);
		gpio_set_pull(EXYNOS4X12_GPIO_B3,S5P_GPIO_PULL_UP);
		break;
	case PERIPH_ID_I2C6:
		gpio_cfg_pin(EXYNOS4X12_GPIO_C13, S5P_GPIO_FUNC(0x4));
		gpio_cfg_pin(EXYNOS4X12_GPIO_C14, S5P_GPIO_FUNC(0x4));
		gpio_set_pull(EXYNOS4X12_GPIO_C13,S5P_GPIO_PULL_UP);
		gpio_set_pull(EXYNOS4X12_GPIO_C14,S5P_GPIO_PULL_UP);
		break;
	case PERIPH_ID_I2C7:
		gpio_cfg_pin(EXYNOS4X12_GPIO_D02, S5P_GPIO_FUNC(0x3));
		gpio_cfg_pin(EXYNOS4X12_GPIO_D03, S5P_GPIO_FUNC(0x3));
		gpio_set_pull(EXYNOS4X12_GPIO_D02,S5P_GPIO_PULL_UP);
		gpio_set_pull(EXYNOS4X12_GPIO_D03,S5P_GPIO_PULL_UP);
        break;
	}
}
