...
#define LED2ON GPL2DAT=1
#define LED2OFF GPL2DAT=0
#define LED3ON GPK1DAT=0x2
#define LED3OFF GPK1DAT=0
void led_blink()
{
    GPL2CON = 0x00000001;
    GPK1CON = 0x00000010;    
...
void board_init_f(ulong bootflag)
{
	 ...
	 */
	addr -= gd->mon_len;
	addr &= ~(0x100000 - 1);//origin is 4096 - 1
